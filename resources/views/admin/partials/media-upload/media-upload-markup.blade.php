    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#media_library" role="tab"
                            id="load_all_media_images" aria-controls="media_library"
                            aria-selected="false">{{ __('Media Library') }}</a>
                    </li>
                </ul>
                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <a tabindex="0" style="display: none"
                                            class=" btn btn-lg btn-danger btn-sm mb-3 mr-1" role="button"
                                            data-placement="right" data-toggle="popover" data-trigger="focus"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary media_upload_modal_submit_btn"
